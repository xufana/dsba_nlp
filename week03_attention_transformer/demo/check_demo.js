/* Check the built demo page in headless Chrome over the DevTools protocol.
   ...
   Run from week03_attention_transformer/demo/ after build_demo.py:
       node check_demo.js                 # checks + screenshots into check_out/
       node check_demo.js week03_demo.html check_steps.json
...
const PAGE = path.resolve(process.argv[2] || "week03_demo.html");
